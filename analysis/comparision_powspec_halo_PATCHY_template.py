...
kd_template, Pkd_template, Variance_template = np.loadtxt("/hpcstorage/zhaoc/share/ting/powspec_cross_ori/power_spec_halos_template/catelogues/average.dat", usecols=(0,1,2), unpack=True)
...
plt.errorbar(kd_PATCHY,Pkd_PATCHY, yerr=Variance_PATCHY, label = "power spectrum of halos of PATCHY mocks")
plt.fill_between(kd_PATCHY, Pkd_PATCHY - Variance_PATCHY, Pkd_PATCHY + Variance_PATCHY, color='red', alpha=0.2)
plt.errorbar(kd_template,Pkd_template, yerr=Variance_template, label = "power spectrum of halos of template mocks")
plt.fill_between(kd_template, Pkd_template - Variance_template, Pkd_template + Variance_template, color='blue', alpha=0.2)
...
plt.savefig("/home/epfl/tan/first-code-document/analysis_cos/output/Comparison of power spectrum of PATCHY and Template")
